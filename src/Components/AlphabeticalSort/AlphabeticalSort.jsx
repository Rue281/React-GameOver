...
export default function AlphabeticalSort() {
  ...
  async function getAllGames(){
    ...
    let {data} = await axios.get(`https://free-to-play-games-database.p.rapidapi.com/api/games?sort-by=alphabetical`,config);
  ...
  return (
    ...
    // role="tabpanel"
    // id={id}
    className="alphabeticalSort container pt-5"
