...
export default function RacingCategory({id,active}) {
  ...
  async function getAllGames(){
    ...
    let {data} = await axios.get(`https://free-to-play-games-database.p.rapidapi.com/api/games?category=racing`,config);
