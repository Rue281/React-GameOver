...
export default function ReleaseDateSort() {
  ...
  async function getAllGames(){
    ...
    let {data} = await axios.get(`https://free-to-play-games-database.p.rapidapi.com/api/games?sort-by=release-date`,config);
  ...
  return (
    ...
    // role="tabpanel"
    // id={id}
    className="releaseDateSort container pt-5"
